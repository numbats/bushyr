...
save(max_temp_raster_crop, lasso_grid, final_lasso, train, test, lowest_rmse, model_df2,
...
```{r vic_grid, fig.cap="Victoria bounding box gridded 20 by 20", eval=FALSE}
...
For a bushfire to ignite, it needs an ignition source and conducive weather conditions. Fire ignitions can be organised into 4 classes- lightning, arson, planned burning off and accident. Previous analysis have suggests that more than 80% of fires can be attributed to lightning. (@the-conv)
Studies have demonstrated empirically a relationship between fire ignitions and weather & landscape conditions. 
