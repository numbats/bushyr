...
extract_ignition_raster_values_bf_season(cause_training_sf,
                                         unique(cause_training_sf$bf_season[1]))
...
- 2016; missing months 10, 11, 12
- clustering data; no weather variables
