...
User can choose the bushfire seasons to overlay historical ignition points. Upon clicking a grid cell, the data table and plots are produced. The table provides information of the different weather and landscape variables. Plots show the historically the number of bushfires and values of each variable which might be of interest to users. These are made downloadable for interested users. 
