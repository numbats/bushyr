...
Bakshi, C. (2020, June 9). Random Forest Regression. gitconnected. https://levelup.gitconnected.com/random-forest-regression-209c0f354c84)

Bates, BC, L McCaw, and AJ Dowdy (2018). Exploratory analysis of lightning-ignited
wildfires in the Warren Region, Western Australia. Journal of environmental management
225, 336–345.

Breiman, L (2001). Random forests. Machine learning 45(1), 5–32.

Ester, M, HP Kriegel, J Sander, X Xu, et al. (1996). A density-based algorithm for discovering
clusters in large spatial databases with noise. In: Kdd. Vol. 96. 34, pp.226–231.

Loboda, T. & Csiszar, I. (2007). Reconstruction of fire spread within wildland fire events in Northern Eurasia from the MODIS active fire product. Global and Planetary Change 56(3-4), 258–273.

Matsuki, K., Kuperman, V., & Dyke, J. A. V. (2016). The Random Forests statistical technique: An examination of its value for the study of reading. Scientific Studies of Reading, 20(1), 20-33.

Merton Council. (2013). Fire Safety Risk Assessment. merton.gov.uk. https://www.merton.gov.uk/assets/Documents/www2/fire_safety_risk_assessment_-_june_2013.pdf

Williamson, G (2020). Example code to generate animation frames of Himawari-8 hotspots.
https://gist.github.com/ozjimbob/80254988922140fec4c06e3a43d069a6 (visited
on 10/10/2021).
